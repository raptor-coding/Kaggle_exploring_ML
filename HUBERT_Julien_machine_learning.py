...
mape = 100 * (mean_absolute_error(y_test, y_pred3) / y_test)
accuracy = 100 - np.mean(mape)
print('Accuracy:', round(accuracy, 2), '%.')


from sklearn.neural_network import MLPClassifier
regressor4 = MLPClassifier(solver='lbfgs', alpha=1e-5, hidden_layer_sizes=(5, 2), random_state=1)
...
mape = 100 * (mean_absolute_error(y_test, y_pred4) / y_test)
accuracy = 100 - np.mean(mape)
print('Accuracy:', round(accuracy, 2), '%.')
...
tree = regressor2.estimators_[5]
# Export the image to a dot file
export_graphviz(tree, out_file = 'tree.dot', feature_names = featuresName, rounded = True, precision = 1)
# Use dot file to create a graph
(graph, ) = pydot.graph_from_dot_file('/Users/jux/Desktop/HUBERT_Julien_test_technique_quantmetry_fevrier_2018/tree.dot')
# Write graph to a png file
graph.write_png('/Users/jux/Desktop/HUBERT_Julien_test_technique_quantmetry_fevrier_2018/tree.png')
'''
